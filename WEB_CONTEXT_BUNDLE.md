...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-gt-001-hadwiger-conjecture-4d179b5c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GT-001"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-gt-001-hadwiger-conjecture-4d179b5c-v1",
      "problem_contract_sha256": "f15efa62849dd22caf5a2a7d000ce96461cdd4612016ff6456da33cbf78f6c31",
      "problem_id": "problem:um-gt-001-hadwiger-conjecture-4d179b5c",
      "route_id": "route:um-gt-001-hadwiger-conjecture-4d179b5c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-gt-001-hadwiger-conjecture-4d179b5c-source-fidelity-01",
      "graph_id": "graph:um-gt-001-hadwiger-conjecture-4d179b5c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-gt-001-hadwiger-conjecture-4d179b5c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-gt-001-hadwiger-conjecture-4d179b5c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Every graph with chromatic number $k$ has a $K_k$ minor (where $K_k$ is the complete graph on $k$ vertices)."
          },
          "statement_sha256": "31d3154c1fae020dcc1c8a3936436ef11bf0eb2164df52ed525d29ab67eccf59"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-gt-001-hadwiger-conjecture-4d179b5c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-gt-001-hadwiger-conjecture-4d179b5c-root",
      "route_id": "route:um-gt-001-hadwiger-conjecture-4d179b5c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-gt-001-d7b44782f98f",
        "url": "https://www.unsolvedmath.com/problems/GT-001"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
